export const priceTagsLS = [
  ...
  [
    ...
    150,
    2,
    "Prawo do uczestnictwa w jednym treningu długiego miecza oraz jednym dowolnie wybranym treningu",
  ],
  [
    "PREMIUM",
    180,
    3,
    "Prawo do uczestnictwa w jednym treningu długiego miecza oraz dwóch dowolnie wybranych treningach",
  ],
  [
    "PREMIUM PLUS",
    210,
...
export const priceTagsAdditionall = [
  ...
  [
    ...
    60,
    1,
    "Prawo do uczestnictwa w treningu Sztyletu lub Półmiecza",
  ],
  ["MESSER", 60, 1, "Prawo do uczestnictwa w seminarium z Korda"],
  ["SZABLA", 60, 1, "Prawo do uczestnictwa w treningu Szabli"],
  [
    "TRENINGI DODATKOWE I",
    100,
    2,
    "Prawo do uczestnictwa w dwóch treningach objętych karnetami dodatkowymi",
  ],
  [
    "TRENINGI DODATKOWE II",
    150,
    4,
...
export const priceTagsSaS = [
  [
    ...
    20,
    1,
    "Wejście na salę raz w tygodniu | Prawo do uczestnictwa w treningu Miecza i Tarczy",
  ],
  [
    "MIECZ I TARCZA, rabat",
    10,
    1,
...
export const listOfOrganisations = [
  ...
  },
  {
    name: "ClubARMA",
    fullName:
      "Stowarzyszenie na rzecz Dawnych Europejskich Sztuk Walki ARMA-PL Warszawa",
    desc: " ",
